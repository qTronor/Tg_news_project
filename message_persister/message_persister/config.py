...
class KafkaConfig(BaseModel):
    ...
    input_topic: str = "raw.telegram.messages"
    output_topic: str = "persisted.messages"
    dlq_topic: str = "dlq.raw.messages"
    consumer_group: str = "message-persister-group"
    client_id: str = "message-persister"
...
class AppConfig(BaseModel):
    service_name: str = "message-persister"
    consumer_id: str = "message-persister"
    source_system: str = "message-persister"
...
class EnvConfig(BaseSettings):
    model_config = SettingsConfigDict(
        env_prefix="MESSAGE_PERSISTER__",
